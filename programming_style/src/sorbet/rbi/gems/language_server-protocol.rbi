...
class LanguageServer::Protocol::Interface::ClientCapabilities
  ...
  def general; end
  def initialize(workspace: nil, text_document: nil, window: nil, general: nil, experimental: nil); end
  def text_document; end
  def to_hash; end
  def to_json(*args); end
  def window; end
...
class LanguageServer::Protocol::Interface::CodeActionContext
  def attributes; end
  def diagnostics; end
  def initialize(diagnostics:, only: nil); end
  def only; end
  def to_hash; end
  def to_json(*args); end
end
...
class LanguageServer::Protocol::Interface::CompletionClientCapabilities
  ...
  def dynamic_registration; end
  def initialize(dynamic_registration: nil, completion_item: nil, completion_item_kind: nil, context_support: nil); end
  def to_hash; end
  def to_json(*args); end
end
...
class LanguageServer::Protocol::Interface::CompletionItem
  ...
  def filter_text; end
  def initialize(label:, kind: nil, tags: nil, detail: nil, documentation: nil, deprecated: nil, preselect: nil, sort_text: nil, filter_text: nil, insert_text: nil, insert_text_format: nil, insert_text_mode: nil, text_edit: nil, additional_text_edits: nil, commit_characters: nil, command: nil, data: nil); end
  def insert_text; end
...
class LanguageServer::Protocol::Interface::CompletionOptions
  ...
  def attributes; end
  def initialize(work_done_progress: nil, trigger_characters: nil, all_commit_characters: nil, resolve_provider: nil); end
  def resolve_provider; end
  def to_hash; end
  def to_json(*args); end
...
class LanguageServer::Protocol::Interface::CompletionRegistrationOptions
  ...
  def attributes; end
  def document_selector; end
  def initialize(document_selector:, work_done_progress: nil, trigger_characters: nil, all_commit_characters: nil, resolve_provider: nil); end
  def resolve_provider; end
  def to_hash; end
  def to_json(*args); end
  def trigger_characters; end
...
class LanguageServer::Protocol::Interface::FoldingRange
  ...
  def end_line; end
  def initialize(start_line:, end_line:, start_character: nil, end_character: nil, kind: nil); end
  def kind; end
...
class LanguageServer::Protocol::Interface::FoldingRangeClientCapabilities
  def attributes; end
  def dynamic_registration; end
  def initialize(dynamic_registration: nil, range_limit: nil, line_folding_only: nil); end
...
class LanguageServer::Protocol::Interface::MarkdownClientCapabilities
  def attributes; end
  def initialize(parser:, version: nil); end
  def parser; end
  def to_hash; end
  def to_json(*args); end
  def version; end
...
class LanguageServer::Protocol::Interface::SemanticTokensClientCapabilities
  ...
  def dynamic_registration; end
  def formats; end
  def initialize(requests:, token_types:, token_modifiers:, formats:, dynamic_registration: nil, overlapping_token_support: nil, multiline_token_support: nil); end
...
class LanguageServer::Protocol::Interface::WorkspaceSymbolClientCapabilities
  def attributes; end
  def dynamic_registration; end
  def initialize(dynamic_registration: nil, symbol_kind: nil, tag_support: nil); end
  def symbol_kind; end
  def tag_support; end
  def to_hash; end
  def to_json(*args); end
